defmodule FlyDeploy.Orchestrator do
  ...
  defp reload_machine(machine_id, region, tarball_url, app, suspend_timeout) do
    reload_machine_with_retries(machine_id, region, tarball_url, app, suspend_timeout, _retries = 3)
  end
  ...
  defp maybe_retry(machine_id, region, tarball_url, app, suspend_timeout, retries, error_result)
    ...
    reload_machine_with_retries(machine_id, region, tarball_url, app, suspend_timeout, retries - 1)
  end
